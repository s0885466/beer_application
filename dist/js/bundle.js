...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar url = exports.url = 'https://api.punkapi.com/v2/beers';\n\n//# sourceURL=webpack:///./src/js/config.js?");
...
"use strict";
eval("\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/js/config.js\");\n\nvar _Beers = __webpack_require__(/*! ./models/Beers */ \"./src/js/models/Beers.js\");\n\nvar _Beers2 = _interopRequireDefault(_Beers);\n\nvar _LS = __webpack_require__(/*! ./models/LS */ \"./src/js/models/LS.js\");\n\nvar _LS2 = _interopRequireDefault(_LS);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nvar _base2 = _interopRequireDefault(_base);\n\nvar _loaderView = __webpack_require__(/*! ./views/loaderView */ \"./src/js/views/loaderView.js\");\n\nvar _beersView = __webpack_require__(/*! ./views/beersView */ \"./src/js/views/beersView.js\");\n\nvar _beersView2 = _interopRequireDefault(_beersView);\n\nvar _pagesView = __webpack_require__(/*! ./views/pagesView */ \"./src/js/views/pagesView.js\");\n\nvar _pagesView2 = _interopRequireDefault(_pagesView);\n\nvar _favoritesView = __webpack_require__(/*! ./views/favoritesView */ \"./src/js/views/favoritesView.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar state = {\n    pages: {\n        page: 1,\n        amount: 6,\n        lastPage: 1\n    }\n};\n\nstate.ls = new _LS2.default('beers');\nstate.controllers = {};\n\nvar dataController = function dataController() {\n    (0, _loaderView.renderLoader)(_base2.default.loader);\n    state.beers = new _Beers2.default(_config.url);\n    state.beers.getData().then(function () {\n        var len = state.beers.data.length;\n        state.pages.lastPage = Math.ceil(len / state.pages.amount);\n\n        //блок который отработает при перезагрузке, если location.hash есть\n        var newPage = parseInt(location.hash.slice(1));\n        //установка в state текущей страницы\n        if (newPage !== NaN && newPage >= 1 && newPage <= state.pages.lastPage) {\n            state.pages.page = newPage;\n        }\n\n        //добавление в state favorites из LocalStorage\n        updateFavorites();\n\n        (0, _loaderView.clearLoader)(_base2.default.loader);\n        (0, _beersView2.default)(state.beers.data, state.pages.page, state.pages.amount);\n        (0, _pagesView2.default)(state.pages.page, state.pages.lastPage);\n        (0, _favoritesView.renderFavorites)(state.beers.data);\n\n        //console.log(state.beers.data);\n    }).catch(function (error) {\n        return console.error('error fetching data', error);\n    });\n};\n\ndataController();\n\n[_base2.default.beers, _base2.default.favorites].forEach(function (elem) {\n    elem.addEventListener('click', function (e) {\n        var target = e.target.closest('[data-favorites]');\n        if (target !== null) {\n            var idFavorites = +target.dataset.favorites;\n\n            state.ls.isIdInLocalStorage(idFavorites) ? state.ls.delFromLocalStorage(idFavorites) : state.ls.addToLocalStorage(idFavorites);\n\n            //добавление в state favorites из LocalStorage\n            updateFavorites();\n            (0, _beersView2.default)(state.beers.data, state.pages.page, state.pages.amount);\n            (0, _favoritesView.renderFavorites)(state.beers.data);\n        }\n    });\n});\n\n//событие на кнопки сортировок\n_base2.default.sort.addEventListener('click', function (e) {\n    var target = e.target.closest('[data-sort_abv]') || e.target.closest('[data-sort_ibu]');\n    if (target !== null) {\n        var sort_abv = target.dataset.sort_abv;\n        var sort_ibu = target.dataset.sort_ibu;\n\n        if (sort_abv) {\n            state.beers.data.sort(function (a, b) {\n                return sort_abv === 'up' ? b.abv - a.abv : a.abv - b.abv;\n            });\n        } else if (sort_ibu) {\n            state.beers.data.sort(function (a, b) {\n                return sort_ibu === 'up' ? b.ibu - a.ibu : a.ibu - b.ibu;\n            });\n        }\n\n        (0, _beersView2.default)(state.beers.data, state.pages.page, state.pages.amount);\n    }\n});\n\n//событие на кнопку очистка избранного\n_base2.default.favorites.addEventListener('click', function (e) {\n    if (e.target.dataset.clear) {\n        (0, _favoritesView.clearFavorites)();\n        state.ls.delAllFromLocalStorage();\n        state.beers.data.forEach(function (el) {\n            el.favorites = false;\n        });\n        (0, _beersView2.default)(state.beers.data, state.pages.page, state.pages.amount);\n    }\n});\n\n//Событие смена hash\nwindow.addEventListener('hashchange', function (e) {\n    var newPage = parseInt(location.hash.slice(1));\n    if (newPage !== NaN && newPage >= 1 && newPage <= state.pages.lastPage) {\n        state.pages.page = newPage;\n\n        (0, _beersView2.default)(state.beers.data, newPage, state.pages.amount);\n        (0, _pagesView2.default)(newPage, state.pages.lastPage);\n        (0, _favoritesView.renderFavorites)(state.beers.data);\n    }\n});\n\nfunction updateFavorites() {\n    if (state.ls.isBeersLocalStorage()) {\n        state.beers.data.forEach(function (el) {\n            if (state.ls.isIdInLocalStorage(el.id)) el.favorites = true;else el.favorites = false;\n        });\n    }\n}\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/models/Beers.js":
/*!********************************!*\
  !*** ./src/js/models/Beers.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar LS = function () {\n    function LS(name) {\n        _classCallCheck(this, LS);\n\n        this.name = name;\n    }\n\n    _createClass(LS, [{\n        key: \"isBeersLocalStorage\",\n        value: function isBeersLocalStorage() {\n            return localStorage.getItem(this.name) ? true : false;\n        }\n    }, {\n        key: \"getArrFromLocalStorage\",\n        value: function getArrFromLocalStorage() {\n            if (localStorage.getItem(this.name) !== null) {\n                return JSON.parse(localStorage.getItem(this.name));\n            }\n            return false;\n        }\n    }, {\n        key: \"addToLocalStorage\",\n        value: function addToLocalStorage(id) {\n            if (!this.isBeersLocalStorage()) {\n                localStorage.setItem(this.name, JSON.stringify([id]));\n            } else {\n                var beers = this.getArrFromLocalStorage();\n                if (!beers.includes(id)) {\n                    beers.push(id);\n                    localStorage.setItem(this.name, JSON.stringify(beers));\n                }\n            }\n        }\n    }, {\n        key: \"delFromLocalStorage\",\n        value: function delFromLocalStorage(id) {\n            var beers = this.getArrFromLocalStorage();\n            var i = beers.findIndex(function (el) {\n                return el === id;\n            });\n            if (i !== -1) {\n                beers.splice(i, 1);\n            }\n            localStorage.setItem(this.name, JSON.stringify(beers));\n        }\n    }, {\n        key: \"delAllFromLocalStorage\",\n        value: function delAllFromLocalStorage() {\n            localStorage.removeItem(this.name);\n        }\n    }, {\n        key: \"isIdInLocalStorage\",\n        value: function isIdInLocalStorage(id) {\n            if (this.isBeersLocalStorage()) {\n                var beers = this.getArrFromLocalStorage();\n                return beers.includes(id);\n            }\n            return false;\n        }\n    }]);\n\n    return LS;\n}();\n\nexports.default = LS;\n\n//# sourceURL=webpack:///./src/js/models/LS.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _base2 = _interopRequireDefault(_base);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar renderBeer = function renderBeer(beer) {\n    var id = beer.id,\n        image_url = beer.image_url,\n        name = beer.name,\n        contributed_by = beer.contributed_by,\n        first_brewed = beer.first_brewed,\n        ibu = beer.ibu,\n        abv = beer.abv,\n        description = beer.description;\n\n    return '\\n        <div class=\"col-md-4 col-sm-6 card border-light\" style=\"width:18rem;\">\\n            <div class=\"container mt-3\">\\n                <div class=\"row\">\\n                    <div class=\"col-md-4\"></div>\\n                    <div class=\"col-md-4\" style=\"display:flex; align-items: flex-end;\">\\n                        <img src=\"' + image_url + '\" class=\"card-img-top\" alt=\"' + name + '\" style=\"width: 70%; height: auto\">\\n                    </div>\\n                    <div class=\"col-md-4\"></div>\\n                </div>\\n            </div>\\n            <div class=\"card-body\">\\n                <h5 class=\"card-title\">' + name + '</h5>\\n                <ul class=\"list-group\">\\n                    <li class=\"list-group-item\">\\u041F\\u043E\\u0441\\u0442\\u0430\\u0432\\u0449\\u0438\\u043A: ' + contributed_by + '</li>\\n                    <li class=\"list-group-item\">\\u0412\\u043F\\u0435\\u0440\\u0432\\u044B\\u0435 \\u0441\\u0432\\u0430\\u0440\\u0435\\u043D\\u043E: ' + first_brewed + '</li>\\n                    <li class=\"list-group-item\">\\u0413\\u043E\\u0440\\u0435\\u0447\\u044C IBU: ' + ibu + '</li>\\n                    <li class=\"list-group-item\">\\u0410\\u043B\\u043A\\u043E\\u0433\\u043E\\u043B\\u044C ' + abv + '%</li>\\n                </ul>\\n                <h6 class=\"mt-2\">\\u041E\\u043F\\u0438\\u0441\\u0430\\u043D\\u0438\\u0435</h6>\\n                <div class=\"overflow-auto\" style=\"max-height: 150px\">\\n                    <p class=\"card-text p-2\">' + description + '</p>\\n                </div>\\n                <button data-favorites =\"' + id + '\" class=\"btn btn-block btn btn-secondary\">\\n                ' + (!beer.favorites ? '<i class=\"far fa-heart\"></i>' : '<i class=\"fas fa-heart\"></i>') + '\\n                \\u0412 \\u0438\\u0437\\u0431\\u0440\\u0430\\u043D\\u043D\\u043E\\u0435</button>\\n            </div>\\n        </div>\\n        ';\n};\n\nvar clearBeers = function clearBeers() {\n    _base2.default.beers.innerHTML = '';\n};\n\nvar renderBeers = function renderBeers(beers) {\n    var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n    var amount = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 6;\n\n    clearBeers();\n    //сортируем массив в зависимости от страницы и количества\n    var firstIndex = (page - 1) * amount;\n    var lastIndex = page * amount - 1;\n    beers = beers.slice(firstIndex, lastIndex + 1);\n\n    var html = beers.map(function (beer) {\n        return renderBeer(beer);\n    }).join('');\n    _base2.default.beers.insertAdjacentHTML('beforeend', html);\n};\n\nexports.default = renderBeers;\n\n//# sourceURL=webpack:///./src/js/views/beersView.js?");

/***/ }),

/***/ "./src/js/views/favoritesView.js":
/*!***************************************!*\
  !*** ./src/js/views/favoritesView.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderFavorites = exports.clearFavorites = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _base2 = _interopRequireDefault(_base);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar renderFavorite = function renderFavorite(beer) {\n    var id = beer.id,\n        name = beer.name;\n\n    return '\\n            <li class=\"list-group-item\">\\n                ' + name + ' <h6 class=\"float-right text-secondary\">\\n                <i data-favorites=\"' + id + '\" class=\"fas fa-trash-alt\" style=\"cursor: pointer\"></i></h6>\\n            </li>\\n    ';\n};\n\nvar btnClearFavorites = function btnClearFavorites() {\n    return '\\n        <button data-clear=\"clear\" class=\"btn btn-secondary btn-block\">\\n        \\u041E\\u0447\\u0438\\u0441\\u0442\\u0438\\u0442\\u044C \\u0432\\u0441\\u0435</i>\\n        </button>\\n  ';\n};\n\nvar clearFavorites = exports.clearFavorites = function clearFavorites() {\n    _base2.default.favorites.innerHTML = '';\n};\n\nvar renderFavorites = exports.renderFavorites = function renderFavorites(beers) {\n    clearFavorites();\n    beers = beers.filter(function (el) {\n        return el.favorites;\n    });\n    var html = beers.map(function (beer) {\n        return renderFavorite(beer);\n    }).join('');\n\n    if (beers.length) {\n        html += btnClearFavorites();\n    }\n\n    _base2.default.favorites.insertAdjacentHTML('beforeend', html);\n};\n\n//# sourceURL=webpack:///./src/js/views/favoritesView.js?");

/***/ }),

/***/ "./src/js/views/loaderView.js":
/*!************************************!*\
  !*** ./src/js/views/loaderView.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearLoader = exports.renderLoader = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _base2 = _interopRequireDefault(_base);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar renderLoader = exports.renderLoader = function renderLoader(parent) {\n    var loader = '\\n            <div class=\"spinner-border\" style=\"width: 3rem; height: 3rem;\" role=\"status\">\\n                <span class=\"sr-only\"></span>\\n            </div>\\n    ';\n    parent.insertAdjacentHTML('afterbegin', loader);\n};\n\nvar clearLoader = exports.clearLoader = function clearLoader(parent) {\n    parent.innerHTML = '';\n};\n\n//# sourceURL=webpack:///./src/js/views/loaderView.js?");

/***/ }),

/***/ "./src/js/views/pagesView.js":
/*!***********************************!*\
  !*** ./src/js/views/pagesView.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _base2 = _interopRequireDefault(_base);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar renderPages = function renderPages(page, lastPage) {\n    var html = \"\\n        \" + (page > 1 ? \"<a href=\\\"#\" + (page - 1) + \"\\\" class=\\\"col-3 badge badge-light p-2\\\">\\u041D\\u0430\\u0437\\u0430\\u0434</a>\" : \"<div class=\\\"col-3\\\"> </div>\") + \"\\n        <div class=\\\"col-6 text-center\\\">\\u0421\\u0442\\u0440\\u0430\\u043D\\u0438\\u0446\\u0430 \" + page + \"(\" + lastPage + \")</div>\\n        \" + (page < lastPage ? \"<a href=\\\"#\" + (page + 1) + \"\\\" class=\\\"col-3 badge badge-light p-2 \\\">\\u0412\\u043F\\u0435\\u0440\\u0435\\u0434</a>\" : '') + \"\\n    \";\n    _base2.default.pages.innerHTML = html;\n};\n\nexports.default = renderPages;\n\n//# sourceURL=webpack:///./src/js/views/pagesView.js?");
