...
"use strict";
eval("\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/js/config.js\");\n\nvar _Data = __webpack_require__(/*! ./models/Data */ \"./src/js/models/Data.js\");\n\nvar _Data2 = _interopRequireDefault(_Data);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar state = {};\nstate.controllers = {};\nstate.controllers.controller1 = function () {\n    console.log('запущен контроллер 1');\n};\nstate.controllers.controller2 = function () {\n    console.log('запущен контроллер 2');\n};\n\nvar dataController = function dataController() {\n    state.beer = new _Data2.default(_config.url);\n    state.beer.getData().then(function () {\n        console.log(state.beer.result);\n    }).catch(function (error) {\n        return console.error('error in dataController', error);\n    });\n};\n\n/*const dataController = async () => {\n  state.beer = new Data(url);\n  await state.beer.getData();\n  console.log(state.beer.result);\n};*/\n\ndataController();\n\nwindow.addEventListener('hashchange', function (event) {\n    var controller = location.hash.slice(1);\n    if (state.controllers[controller]) {\n        state.controllers[controller]();\n    }\n});\n\nwindow.addEventListener('load', function (event) {\n    var controller = location.hash.slice(1);\n    if (state.controllers[controller]) {\n        state.controllers[controller]();\n    }\n});\n\nfunction router(controller) {}\n\n//# sourceURL=webpack:///./src/js/index.js?");
